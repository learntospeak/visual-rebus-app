...
export function makeKitchen(canvas){
 ...
 const shots=[{t:0,p:[3.5,3.45,6.5],a:[-.5,2.35,-.6]},{t:5,p:[1.9,3.02,4.0],a:[0,2.35,-.12]},{t:8,p:[1.65,2.95,3.9],a:[0,2.28,-.1]},{t:11,p:[2.3,2.98,4.25],a:[3.38,2.45,-1.35]},{t:15,p:[2.3,2.98,4.25],a:[3.38,2.45,-1.35]},{t:18.5,p:[1.65,3.05,3.85],a:[0,2.3,-.1]},{t:22,p:[1.5,3.03,3.85],a:[0,2.3,-.1]}];
 ...
 function draw({time=0,delta=0,view='auto',running=false,won=false,instant=false}={}){
  ...
  if(view==='away'){p=[1.9,3.05,4.1];a=[2.55,2.35,-1.1];}
  if(view==='watch'){p=[1.05,3.12,3.65];a=[0,2.32,-.08];}
  if(view==='inspect'){p=[1.3,3.7,2.85];a=[.18,2.25,-.08];}
  ...
  fire.visible=!won;fire.children.forEach((f,i)=>f.scale.y=.88+Math.sin(physical*12+i*3)*.13);
