...
const reviewedPuzzleIds = new Set([
  ...
  257, 258, 260, 261, 271, 272, 273, 274, 275, 276, 277, 278, 279, 280, 291, 292, 293, 294, 295, 296, 297, 298, 299, 300, 301, 302, 303, 304, 305, 306, 307, 308, 309, 310, 328, 337, 357, 392, 400, 435, 477, 497, 554,
])
...
export function ReviewedPuzzleArt({ id }: { id: number }) {
  ...
  if (id === 254) return <div className="puzzle-visual reviewed-puzzle-art reviewed-254" role="img" aria-label="A polished analogue clock is naturally cradled in two realistic open human hands"><span className="time-hands-clock-scene" /></div>
